package com.likelion.openapi_assignment.post.api;
...
import com.likelion.openapi_assignment.post.application.PostService;
...
public class PostController {
    ...
    public ApiResTemplate<PostInfoResponseDto>deletePostImage(@PathVariable Long postId){
        PostInfoResponseDto response = postService.deleteImage(postId);
